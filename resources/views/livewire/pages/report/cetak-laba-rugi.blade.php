<div>
    <div class="mb-6">
        <h1 class="text-lg font-bold text-center text-gray-900 ">LAPORAN LABA RUGI</h1>
    ...
    <div class="overflow-x-auto">
        <table class="w-full" style="font-size: 10px; border: 2px solid #000; border-collapse: collapse;">
            <thead>
                <tr style="background-color: #f5f5f5;">
                    @if ($filterType === 'hari')
                        ...
                        <th class="text-left py-2 px-2" style="width: 50%; border: 1px solid #000;">Detail Barang</th>
                        <th class="text-center py-2 px-2" style="width: 20%; border: 1px solid #000;">Jumlah</th>
                    @else
                        <th class="text-center py-2 px-2" style="width: 5%; border: 1px solid #000;">No</th>
                        <th class="text-center py-2 px-2" style="width: 25%; border: 1px solid #000;">
                            {{ $filterType === 'bulan' ? 'Minggu Ke' : 'Bulan' }}</th>
                        <th class="text-center py-2 px-2" style="width: 23%; border: 1px solid #000;">Pendapatan</th>
                        <th class="text-center py-2 px-2" style="width: 23%; border: 1px solid #000;">Pengeluaran</th>
                        <th class="text-center py-2 px-2" style="width: 24%; border: 1px solid #000;">Uang Bersih</th>
                    @endif
                </tr>
            </thead>
            <tbody>
                    ...
                    @else
                        <tr>
                            ...
                            <td class="py-2 px-2 text-right" style="border: 1px solid #000;">Rp
                                {{ $formatRupiah($row['pendapatan']) }}</td>
                            <td class="py-2 px-2 text-right" style="border: 1px solid #000;">Rp
                                {{ $formatRupiah($row['pengeluaran']) }}</td>
                            <td class="py-2 px-2 text-right" style="border: 1px solid #000;">
                                Rp {{ $formatRupiah(abs($row['bersih'])) }}
                            </td>
                        </tr>
                    @endif
                @empty
                    <tr>
                        <td colspan="5" class="py-4 text-center" style="border: 1px solid #000;">Belum ada data untuk
                            periode ini</td>
                    </tr>
                @endforelse
            </tbody>
            <tfoot>
                <tr style="background-color: #f5f5f5;">
                    <td colspan="{{ $filterType === 'hari' ? '4' : '4' }}" class="py-2 px-2 font-bold text-left"
                        style="border: 1px solid #000;">Total Pendapatan</td>
                ...
                <tr style="background-color: #f5f5f5;">
                    <td colspan="{{ $filterType === 'hari' ? '4' : '4' }}" class="py-2 px-2 font-bold text-left"
                        style="border: 1px solid #000;">Total Pengeluaran</td>
                    <td class="py-2 px-2 text-right font-bold" style="border: 1px solid #000;">Rp
                ...
                <tr style="background-color: #e5e5e5;">
                    <td colspan="{{ $filterType === 'hari' ? '4' : '4' }}" class="py-2 px-2 font-bold text-left"
                        style="border: 1px solid #000;">Total Uang Bersih</td>
                    <td class="py-2 px-2 text-right font-bold" style="border: 1px solid #000;">
                        Rp {{ $formatRupiah(abs($totalPendapatan - $totalPengeluaran)) }}
                    </td>
                    @if ($filterType !== 'hari')
                        <td colspan="2" style="border: 1px solid #000;"></td>
                    @endif
