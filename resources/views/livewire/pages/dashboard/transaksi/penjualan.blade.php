<div>
    <div class="p-8">
        <div class="mb-8">
            <h2 class="text-3xl font-bold text-gray-900">Transaksi Penjualan</h2>
            <p class="text-gray-600 mt-2">Kelola penjualan barang kepada pelanggan</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow p-6 border border-blue-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-900">{{ $summary['total_penjualan'] }}</p>
                    </div>
                    <i class="fas fa-shopping-bag text-4xl text-blue-300"></i>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow p-6 border border-purple-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-900">{{ $summary['penjualan_bulan_ini'] }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl shadow p-6 border border-orange-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-orange-700 mb-1">Piutang Tertanggur</p>
                        <p class="text-3xl font-bold text-orange-900">{{ $summary['piutang_tertanggur'] }}</p>
                    </div>
            ...
            <div class="mb-6 space-y-4">
                <div class="flex flex-col md:flex-row gap-4 items-start md:items-center">
                    <div class="flex-1 max-w-md">
                        <input type="text" wire:model.live.debounce-300ms="search" placeholder="🔍 Cari bukti..."
                    ...
                    <tbody>
                        @forelse($penjualans as $penjualan)
                            <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                <td class="py-4 px-4">
                                    <span
                                        class="text-sm text-gray-600">{{ $penjualan->created_at->format('d M Y H:i') }}</span>
                                </td>
                                ...
                                <td class="py-4 px-4">
                                    <span
                                        ...
                                        @if ($penjualan->pembayaran === 'cash') bg-green-100 text-green-800
                                        @else
                                            bg-blue-100 text-blue-800 @endif">
                                        <i
                                            class="fas @if ($penjualan->pembayaran === 'cash') fa-money-bill-wave @else fa-bank @endif"></i>
                                ...
                                <td class="py-4 px-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <button wire:click="delete({{ $penjualan->id }})"
                                            wire:confirm="Yakin hapus penjualan ini?"
                            ...
                            <tr>
                                <td colspan="5" class="py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-400 text-sm mt-1">Mulai dengan menambahkan penjualan baru
                                        </p>
                                    </div>
                                </td>
                            </tr>
