<div>
    <div class="p-8">
        <div class="mb-8">
            <h2 class="text-3xl font-bold text-gray-900">Laporan Pendapatan</h2>
            <p class="text-gray-600 mt-2">Analisis pendapatan berdasarkan periode yang dipilih</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row gap-4 items-end justify-between">
                ...
                <div>
                    <a href="{{ route('laporan.pendapatan.cetak', ['type' => $filterType, 'tanggal' => $tanggal, 'bulan' => $bulan, 'tahun' => $tahun, 'tahunFilter' => $tahunFilter]) }}"
                        target="_blank"
