<div>
    <div class="p-8">
        <div class="mb-8">
            <h2 class="text-3xl font-bold text-gray-900">Manajemen Pengeluaran</h2>
            <p class="text-gray-600 mt-2">Kelola semua pengeluaran perusahaan Anda</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2">{{ $pengeluarans->total() }}</p>
                    </div>
            ...
            {{-- <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-purple-100 text-sm font-medium">Rata-rata Pengeluaran</p>
                        <p class="text-3xl font-bold mt-2">Rp
                            {{ $pengeluarans->total() > 0 ? number_format($totalPengeluaran / $pengeluarans->total(), 0, ',', '.') : '0' }}
                        </p>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 text-lg">Belum ada data pengeluaran</p>
                </div>
            @endif
        </div>
    </div>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <form wire:submit.prevent="save" class="space-y-4">
                            <div>
                                ...
                                <input type="text" wire:model="sumber" placeholder="Contoh: Gaji Karyawan"
                            ...
                            <div>
                                ...
                                <textarea wire:model="keterangan" rows="3" placeholder="Masukkan keterangan pengeluaran"
