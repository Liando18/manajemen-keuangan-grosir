...
class Pengeluaran extends Component
{
    ...
    public function laporanHarian()
    {
        ...
        $pengeluarans = PengeluaranModel::whereDate('created_at', $date)
    ...
    public function laporanBulanan()
    {
        ...
        for ($date = $startDate->clone(); $date <= $endDate; $date->addDay()) {
            ...
            $dayPengeluaran += PengeluaranModel::whereDate('created_at', $date->toDateString())
                ->whereNotIn('sumber', ['Penjualan Barang', 'Pembelian Barang'])
                ->sum('jumlah');
    ...
    public function laporanTahunan()
    {
        ...
        for ($month = 1; $month <= 12; $month++) {
            ...
            $total += PengeluaranModel::whereBetween('created_at', [$startDate, $endDate])
                ->whereNotIn('sumber', ['Penjualan Barang', 'Pembelian Barang'])
                ->sum('jumlah');
    ...
    {
        return view('livewire.pages.dashboard.laporan.pengeluaran', [
